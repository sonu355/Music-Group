...
function purchaseClicked(eventreturnitle){
...
function addItemToCart( title,price,imageSrc){
    ...
    var carItems = document.getElementsByClassName('cart-item')[0]
    ...
    var cartRowContents = `
        <div class="cart-item cart-column" >
            <img class="cart-item-image" src="${imageSrc}" width="75px"height="75px">
            <span class="cart-item-title">${title}</span>
        </div>
        <span class="cart-title}</span>
        </div>
        <span class="cart-price cart-column">$19.99</span>
        <div class="cart-quantity cart-column">price cart-column">${price}</span>
...
function updateCartTotal(){
    ...
    for(var i = 0; i < cartRows.length; i++){
        ...
        var priceElement = cartRow.getElementsByClassName('cart-rows')[0]
